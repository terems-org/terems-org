webzContent({
	...
	"navLinks": [
		...
		// {"url": "http://rivetsjs.com/docs/reference/", "title": "Rivets.js?"},
		// {"url": "http://fs.to/", "title": "fs.to"},
	],
	...
	"dialogButtons": [
		...
		//},{
		//	"text": "<hr><h2 style='width:100%;text-align:center;color:rgba(255,255,255,0.5)'>Bookmarks</h2><hr>",
		//	"url": "#",
		//},{
		//	"text": "<p><i><u>настроение</u></i> - это <i><u>душа</u></i>, тогда как <i><u>разум</u></i> - это всего лишь средство связи между <i><u>настроением</u></i> (тоесть <i><u>душой</u></i>) и тем проявлением <i><u>реальности</u></i>, которое ты сам же себе и выбираешь&nbsp;...</p>",
		//	"url": "//maqota.org/",
		},
	],
